  ...
  <div class="container bg-light " style="width: 90%;">
    <div class="row justify-content-center m-4">
      <div class="col-md-10">
        ...
        <form class="row needs-validation" novalidate method="POST" action="/Forms-atualizar" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <hr>
          ...
          <div class="col-md-3 mb-4">
            <input type="date" class="form-control" id="dataDeNascimento" name="dataNascimento" value="{{$aluno->dataNascimento}}" placeholder="Data de nascimento *" readonly>
            <div class="valid-feedback">
              Ok!
            </div>
          </div>
          ...
          <div class="col-md-3 mb-4">
            <input type="text" class="form-control" id="genero" name="genero" value="{{$aluno->genero}}" placeholder="Genero *" readonly>
          </div>
          <div class="col-md-3 mb-4">
            <input type="number" min="1" class="form-control" id="peso" name="peso" value="{{$aluno->peso}}" placeholder="Peso *" required>
            <div class="valid-feedback">
              Ok!
            </div>
          </div>
          <div class="col-md-3 mb-4">
            <input type="number" min="1" class="form-control" id="altura" name="altura" value="{{$aluno->altura}}" placeholder="Altura *" required>
            <div class="valid-feedback">
              Ok!
            </div>
          </div>

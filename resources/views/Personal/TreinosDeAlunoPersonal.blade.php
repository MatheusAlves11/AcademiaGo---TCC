    ...
    <div class="container bg-light " style="width: 90%;text-align: center;">
        ...
        <div class="row ">
            ...
            <div class="col-sm-10">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="/detalhesDeTreinoDeAluno/{{$aluno->id}}?treino={{$treinoExpecifico->id}}">Treino {{$treinoExpecifico->nome}}</a></td>
                ...
                @else
                    <a class="btn btn-primary mb-4 " href="/criarTreino/{{$entidade->id}}">Gerar sugestão de treino</a>
                @endif
            </div>
        </div>
    </div>
